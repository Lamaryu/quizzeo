...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 28 juin 2022 à 11:04
...
(1, 1, 'Combien de pokemon il y a dans la première génération ?', '2022-06-28'),
(2, 1, 'Quelle est le type de Dracaufeu', '2022-06-28'),
(3, 1, 'Quelle est l\'évolution final de Carapuce ?', '2022-06-28'),
(4, 1, 'Quelle Pokemon on trouve sous le camion de Carmin-sur-mer selon la légende?', '2022-06-28'),
(5, 1, 'A quoi sert la Masterball', '2022-06-28');
...
CREATE TABLE IF NOT EXISTS `quizz` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_quizzeur` int(11) NOT NULL,
  `titre` varchar(100) NOT NULL,
  `difficulte` varchar(100) NOT NULL,
  `date_creation` date NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_quizzeur` (`id_quizzeur`)
...
INSERT INTO `quizz` (`id`, `id_quizzeur`, `titre`, `difficulte`, `date_creation`) VALUES
(1, 1, 'Pokemon 1ere génération', 'Facile', '2022-06-28');
...
--
ALTER TABLE `quizz`
  ADD CONSTRAINT `quizz_ibfk_1` FOREIGN KEY (`id_quizzeur`) REFERENCES `user` (`id`);
COMMIT;
